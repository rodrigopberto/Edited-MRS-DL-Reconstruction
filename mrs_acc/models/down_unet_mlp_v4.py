...
class DownUnet2DMLPV4(nn.Module):
    ...
    def __init__(self,depth_1d=3,kernel_sizes_1d = [3,5,7,9],initial_filters=4,transients=40,input_channels=2,kernel_size=3):
        ...
        self.mlp_layer_1 = nn.Linear(self.zoom_size*initial_filters*4,self.zoom_size*4)
        self.mlp_layer_1_5 = nn.Linear(self.zoom_size*4,self.zoom_size)
    ...
    def forward(self,x,ppm=None):
        ...
        y_out_mlp = F.relu(self.mlp_layer_2(F.relu(self.mlp_layer_1_5(F.relu(self.mlp_layer_1(y_zoom))))))
...
class _ZoomMLPDownUnet2D(nn.Module):
    def __init__(self,initial_filters=4,transients=40,input_channels=2,kernel_size=3,zoom_size=300):
        ...
        #self.mid_block_mlp_2 = nn.Linear(int(self.zoom_size*initial_filters*20/4),int(self.zoom_size*initial_filters*20/4))
