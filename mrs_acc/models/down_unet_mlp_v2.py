...
class DownUnet2DMLPV2(nn.Module):
    ...
    def __init__(self,depth_1d=3,kernel_sizes_1d = [3,5,7,9],initial_filters=4,transients=40,input_channels=2,kernel_size=3):
        ...
        self.mid_block_conv = _DownUnet2DBlock(initial_filters*(2**(3)),int(initial_filters*(2**3)-10),kernel_size=kernel_size)

        self.mid_block_mlp = nn.Linear(64*128*24,int(128*20*10))
        #self.mid_block_mlp_2 = nn.Linear(self.zoom_size*initial_filters*16,self.zoom_size*initial_filters*16)
