...
output_path = "C:\Users\rodrigo\Documents\thesis\data\gannet_acc_load";
...
for i = 1:length(ge_input_output_list)
    ...
    mrs_struct = GannetLoad4xAccNoGraph({convertStringsToChars(input_filename)})
...
for i = 1:length(ph_input_output_list)
    ...
    mrs_struct = GannetLoad4xAccNoGraph({convertStringsToChars(input_filename)},{convertStringsToChars(input_filename_h20)})
    save(output_filename,"mrs_struct")
end
